...
% We finally look at the ability of these measures to capture contentious relationships not involving the US \ref{missing:dyads}. For the Korean relationship, latent angle distance better characterizes the relationship as enmity, while S-scores treat the two as having very similar preferences. UN ideal point measure treats their relationships as moderate or neutral. Whereas for Iran and Iraq's relationship S-scores give a consistent close preferences (where data exists), while the latent angle metric show more instability, and notable elevation (though not as large as we would expect) during the 1980-88 war. Most interestingly, the UN ideal point measures find Iran and Iraq have a relatively positive relationship when the two states are actually at war.
